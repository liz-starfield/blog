...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-应用" tabindex="-1"><a class="header-anchor" href="#_4-应用" aria-hidden="true">#</a> 4. 应用</h2><h3 id="_4-1-抓取网站数据" tabindex="-1"><a class="header-anchor" href="#_4-1-抓取网站数据" aria-hidden="true">#</a> 4.1. 抓取网站数据</h3><ul><li>使用requests从url获取数据</li><li>使用BeautifulSoup解析页面内容</li></ul>`,111),b={href:"https://www.crummy.com/software/BeautifulSoup/bs4/doc/#quick-start",target:"_blank",rel:"noopener noreferrer"},h=n(`<p>导包</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>pip install requests
