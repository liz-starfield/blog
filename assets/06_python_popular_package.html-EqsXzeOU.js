import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o as l,c as u,f as r,a as n,b as s,d as t,e as a}from"./app-KJHtdF_7.js";const c="/blog/assets/graph_result-I2yjCKiU.png",o="/blog/assets/popular_package_1-7Yc28Iol.png",d="/blog/assets/popular_package_2-8ugBXZdT.png",m={},v=a('<h1 id="popular-third-party-python-packages" tabindex="-1"><a class="header-anchor" href="#popular-third-party-python-packages" aria-hidden="true">#</a> Popular Third-party Python Packages</h1><ul><li><ol><li>Numpy</li></ol></li><li><ol start="2"><li>Pandas</li></ol></li><li><ol start="3"><li>Requests</li></ol></li><li><ol start="4"><li>Flask</li></ol></li><li><ol start="5"><li>More</li></ol></li></ul>',2),b=a(`<h2 id="_1-numpy" tabindex="-1"><a class="header-anchor" href="#_1-numpy" aria-hidden="true">#</a> 1. Numpy</h2><p>numpy, called numeric python. It is one of the most popular packages in machine learning and data science community. It contains among other things:a powerful N-dimensional array objectsophisticated (broadcasting) functionstools for integrating C/C++ and Fortran codeuseful linear algebra, Fourier transform, and random number capabilities</p><h3 id="_1-1-install" tabindex="-1"><a class="header-anchor" href="#_1-1-install" aria-hidden="true">#</a> 1.1. Install</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pip install numpy
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-flask" tabindex="-1"><a class="header-anchor" href="#_4-flask" aria-hidden="true">#</a> 4. Flask</h2><p>web框架的一种前提：设置虚拟环境</p>`,7),_={href:"https://github.com/Asabeneh/30-Days-Of-Python/blob/master/26_Day_Python_web/26_python_web.md",target:"_blank",rel:"noopener noreferrer"},y=n("h2",{id:"_5-more",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_5-more","aria-hidden":"true"},"#"),s(" 5. More")],-1),g=n("p",null,[n("img",{src:o,alt:"",loading:"lazy"}),n("img",{src:d,alt:"",loading:"lazy"})],-1);function x(f,q){const e=p("ExternalLinkIcon");return l(),u("div",null,[v,r(" more "),b,n("p",null,[n("a",k,[s("pandas使用"),t(e)])]),h,n("p",null,[n("a",_,[s("virtual_environmentpython_web"),t(e)])]),y,g])}const P=i(m,[["render",x],["__file","06_python_popular_package.html.vue"]]);export{P as default};
