import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as a,d as s,f as e}from"./app-KkT-fVWF.js";const d="/blog/assets/positive_index-u3W5LQ1U.png",l="/blog/assets/negative_index-X0T7VD_c.png",t={},r=e('<h1 id="python-data-types" tabindex="-1"><a class="header-anchor" href="#python-data-types" aria-hidden="true">#</a> Python Data Types</h1><ul><li><a href="#1-data-types">1. Data Types</a></li><li><a href="#2-string-operations">2. String Operations</a></li><li><a href="#3-list-operations">3. List Operations</a></li><li><a href="#4-tuple-operations">4. Tuple Operations</a></li><li><a href="#5-set-operations">5. Set Operations</a></li><li><a href="#6-dictionary-operations">6. Dictionary Operations</a></li></ul>',2),v=e(`<h2 id="_1-data-types" tabindex="-1"><a class="header-anchor" href="#_1-data-types" aria-hidden="true">#</a> 1. Data Types</h2><h3 id="_1-1-number-数字" tabindex="-1"><a class="header-anchor" href="#_1-1-number-数字" aria-hidden="true">#</a> 1.1. Number 数字</h3><h4 id="_1-1-1-integer-整数-正整数-负整数-十进制-十六进制" tabindex="-1"><a class="header-anchor" href="#_1-1-1-integer-整数-正整数-负整数-十进制-十六进制" aria-hidden="true">#</a> 1.1.1. Integer 整数（正整数，负整数；十进制，十六进制）</h4><p>Python允许在数字中间以_分隔，因此，写成10_000_000_000和10000000000是完全一样的。十六进制数也可以写成0xa1b2_c3d4。</p><p>注意：Python的整数没有大小限制，而某些语言的整数根据其存储长度是有大小限制的，例如Java对32位整数的范围限制在-2147483648-2147483647。</p><h4 id="_1-1-2-float-浮点数-普通表示-科学计数法表示" tabindex="-1"><a class="header-anchor" href="#_1-1-2-float-浮点数-普通表示-科学计数法表示" aria-hidden="true">#</a> 1.1.2. Float 浮点数（普通表示，科学计数法表示）</h4><p>用科学计数法表示，把10用e替代，1.23x10<sup>9</sup>就是1.23e<sup>9</sup>，0.000012可以写成1.2e<sup>-5</sup>，等等。</p><p>注意：Python的浮点数也没有大小限制，但是超出一定范围就直接表示为inf（无限大）。</p><h3 id="_1-2-string-字符串" tabindex="-1"><a class="header-anchor" href="#_1-2-string-字符串" aria-hidden="true">#</a> 1.2. String 字符串</h3><h4 id="_1-2-1-单行内容和多行内容" tabindex="-1"><a class="header-anchor" href="#_1-2-1-单行内容和多行内容" aria-hidden="true">#</a> 1.2.1. 单行内容和多行内容</h4><h5 id="_1-2-1-1-单行内容" tabindex="-1"><a class="header-anchor" href="#_1-2-1-1-单行内容" aria-hidden="true">#</a> 1.2.1.1. 单行内容</h5><ul><li>用单引号&#39;或双引号&quot;括起来表示单行内容</li><li>单行内容为了美观用反斜杠\\换行写，实际还是单行内容</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 用&#39;表示单行内容
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_1-9-dictionary-key-value-对-无序" tabindex="-1"><a class="header-anchor" href="#_1-9-dictionary-key-value-对-无序" aria-hidden="true">#</a> 1.9. Dictionary（key value 对，无序）</h3><p>a value could be any data types</p><h2 id="_2-string-operations" tabindex="-1"><a class="header-anchor" href="#_2-string-operations" aria-hidden="true">#</a> 2. String Operations</h2><h3 id="_2-1-连接join" tabindex="-1"><a class="header-anchor" href="#_2-1-连接join" aria-hidden="true">#</a> 2.1. 连接join</h3><p>方式一：+</p><p>方式二：&#39;连接符&#39;.join(序列)</p><p>方式三：&quot;hello&quot;<em>3 字符串</em>3=3个字符串连接 &#39;hellohellohello&#39;</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># +号连接
...
&quot;&quot;&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-tuple-operations" tabindex="-1"><a class="header-anchor" href="#_4-tuple-operations" aria-hidden="true">#</a> 4. Tuple Operations</h2><h3 id="_4-1-access" tabindex="-1"><a class="header-anchor" href="#_4-1-access" aria-hidden="true">#</a> 4.1. Access</h3><p>tpl[index]</p><p>• 正索引</p><p>• 负索引</p><figure><img src="`+d+'" alt="正索引" tabindex="0" loading="lazy"><figcaption>正索引</figcaption></figure><figure><img src="'+l+`" alt="负索引" tabindex="0" loading="lazy"><figcaption>负索引</figcaption></figure><h3 id="_4-2-unpack" tabindex="-1"><a class="header-anchor" href="#_4-2-unpack" aria-hidden="true">#</a> 4.2. Unpack</h3><p>tuple同list一致</p><p>1）item1,item2,*rest = tpl</p><p>2）*tpl</p><h3 id="_4-3-slice" tabindex="-1"><a class="header-anchor" href="#_4-3-slice" aria-hidden="true">#</a> 4.3. Slice</h3><p>tpl[start🔚step]</p><h3 id="_4-4-changetype" tabindex="-1"><a class="header-anchor" href="#_4-4-changetype" aria-hidden="true">#</a> 4.4. ChangeType</h3><p>lst = list(tpl)</p><p>tpl=tuple(list)</p><h3 id="_4-5-contain" tabindex="-1"><a class="header-anchor" href="#_4-5-contain" aria-hidden="true">#</a> 4.5. Contain</h3><p>item in tpl</p><h3 id="_4-6-connect" tabindex="-1"><a class="header-anchor" href="#_4-6-connect" aria-hidden="true">#</a> 4.6. Connect</h3><p>tpl3 = tpl1 + tpl2 + tpl3</p><h3 id="_4-7-delete" tabindex="-1"><a class="header-anchor" href="#_4-7-delete" aria-hidden="true">#</a> 4.7. Delete</h3><p>del关键字</p><p>del tpl</p><h2 id="_5-set-operations" tabindex="-1"><a class="header-anchor" href="#_5-set-operations" aria-hidden="true">#</a> 5. Set Operations</h2><h3 id="_5-1-create" tabindex="-1"><a class="header-anchor" href="#_5-1-create" aria-hidden="true">#</a> 5.1. Create</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. empty
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-dictionary-operations" tabindex="-1"><a class="header-anchor" href="#_6-dictionary-operations" aria-hidden="true">#</a> 6. Dictionary Operations</h2><h3 id="_6-1-create" tabindex="-1"><a class="header-anchor" href="#_6-1-create" aria-hidden="true">#</a> 6.1. Create</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1、empty
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,266);function c(u,o){return i(),a("div",null,[r,s(" more "),v])}const p=n(t,[["render",c],["__file","02_python_data_type.html.vue"]]);export{p as default};
