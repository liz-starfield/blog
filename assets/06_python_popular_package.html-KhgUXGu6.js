import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o as l,c as u,d as r,a as n,b as s,e as t,f as a}from"./app-KkT-fVWF.js";const c="/blog/assets/graph_result-I2yjCKiU.png",o="/blog/assets/popular_package_1-7Yc28Iol.png",d="/blog/assets/popular_package_2-8ugBXZdT.png",m={},v=a('<h1 id="popular-third-party-python-packages" tabindex="-1"><a class="header-anchor" href="#popular-third-party-python-packages" aria-hidden="true">#</a> Popular Third-party Python Packages</h1><ul><li><a href="#1-numpy">1. Numpy</a></li><li><a href="#2-pandas">2. Pandas</a></li><li><a href="#3-requests">3. Requests</a></li><li><a href="#4-flask">4. Flask</a></li><li><a href="#5-More">5. More</a></li></ul>',2),b=a(`<h2 id="_1-numpy" tabindex="-1"><a class="header-anchor" href="#_1-numpy" aria-hidden="true">#</a> 1. Numpy</h2><p>numpy, called numeric python. It is one of the most popular packages in machine learning and data science community. It contains among other things:a powerful N-dimensional array objectsophisticated (broadcasting) functionstools for integrating C/C++ and Fortran codeuseful linear algebra, Fourier transform, and random number capabilities</p><h3 id="_1-1-install" tabindex="-1"><a class="header-anchor" href="#_1-1-install" aria-hidden="true">#</a> 1.1. Install</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pip install numpy
