import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as a,f as s,e}from"./app-4jXQnbjM.js";const d="/blog/assets/positive_index-u3W5LQ1U.png",l="/blog/assets/negative_index-X0T7VD_c.png",t={},r=e('<h1 id="python-data-types" tabindex="-1"><a class="header-anchor" href="#python-data-types" aria-hidden="true">#</a> Python Data Types</h1><ul><li><ol><li>Data Types</li></ol></li><li><ol start="2"><li>String Operations</li></ol></li><li><ol start="3"><li>List Operations</li></ol></li><li><ol start="4"><li>Tuple Operations</li></ol></li><li><ol start="5"><li>Set Operations</li></ol></li><li><ol start="6"><li>Dictionary Operations</li></ol></li></ul>',2),v=e(`<h2 id="_1-data-types" tabindex="-1"><a class="header-anchor" href="#_1-data-types" aria-hidden="true">#</a> 1. Data Types</h2><h3 id="_1-1-number-数字" tabindex="-1"><a class="header-anchor" href="#_1-1-number-数字" aria-hidden="true">#</a> 1.1. Number 数字</h3><h4 id="_1-1-1-integer-整数-正整数-负整数-十进制-十六进制" tabindex="-1"><a class="header-anchor" href="#_1-1-1-integer-整数-正整数-负整数-十进制-十六进制" aria-hidden="true">#</a> 1.1.1. Integer 整数（正整数，负整数；十进制，十六进制）</h4><p>Python允许在数字中间以_分隔，因此，写成10_000_000_000和10000000000是完全一样的。十六进制数也可以写成0xa1b2_c3d4。</p><p>注意：Python的整数没有大小限制，而某些语言的整数根据其存储长度是有大小限制的，例如Java对32位整数的范围限制在-2147483648-2147483647。</p><h4 id="_1-1-2-float-浮点数-普通表示-科学计数法表示" tabindex="-1"><a class="header-anchor" href="#_1-1-2-float-浮点数-普通表示-科学计数法表示" aria-hidden="true">#</a> 1.1.2. Float 浮点数（普通表示，科学计数法表示）</h4><p>用科学计数法表示，把10用e替代，1.23x10<sup>9</sup>就是1.23e<sup>9</sup>，0.000012可以写成1.2e<sup>-5</sup>，等等。</p><p>注意：Python的浮点数也没有大小限制，但是超出一定范围就直接表示为inf（无限大）。</p><h3 id="_1-2-string-字符串" tabindex="-1"><a class="header-anchor" href="#_1-2-string-字符串" aria-hidden="true">#</a> 1.2. String 字符串</h3><h4 id="_1-2-1-单行内容和多行内容" tabindex="-1"><a class="header-anchor" href="#_1-2-1-单行内容和多行内容" aria-hidden="true">#</a> 1.2.1. 单行内容和多行内容</h4><h5 id="_1-2-1-1-单行内容" tabindex="-1"><a class="header-anchor" href="#_1-2-1-1-单行内容" aria-hidden="true">#</a> 1.2.1.1. 单行内容</h5><ul><li>用单引号&#39;或双引号&quot;括起来表示单行内容</li><li>单行内容为了美观用反斜杠\\换行写，实际还是单行内容</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 用&#39;表示单行内容
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,267);function c(u,m){return i(),a("div",null,[r,s(" more "),v])}const p=n(t,[["render",c],["__file","02_python_data_type.html.vue"]]);export{p as default};
