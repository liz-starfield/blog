import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as a,d as s,f as e}from"./app-KkT-fVWF.js";const d="/blog/assets/positive_index-u3W5LQ1U.png",l="/blog/assets/negative_index-X0T7VD_c.png",t={},r=e('<h1 id="python的数据类型" tabindex="-1"><a class="header-anchor" href="#python的数据类型" aria-hidden="true">#</a> Python的数据类型</h1><ul><li><a href="#1-%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B">1. 数据类型</a></li><li><a href="#2-string%E6%93%8D%E4%BD%9C">2. String操作</a></li><li><a href="#3-list%E6%93%8D%E4%BD%9C">3. List操作</a></li><li><a href="#4-tuple%E6%93%8D%E4%BD%9C">4. Tuple操作</a></li><li><a href="#5-set%E6%93%8D%E4%BD%9C">5. Set操作</a></li><li><a href="#6-dictionary%E6%93%8D%E4%BD%9C">6. Dictionary操作</a></li></ul>',2),v=e(`<h2 id="_1-数据类型" tabindex="-1"><a class="header-anchor" href="#_1-数据类型" aria-hidden="true">#</a> 1. 数据类型</h2><h3 id="_1-1-number-数字" tabindex="-1"><a class="header-anchor" href="#_1-1-number-数字" aria-hidden="true">#</a> 1.1. Number 数字</h3><h4 id="_1-1-1-integer-整数-正整数-负整数-十进制-十六进制" tabindex="-1"><a class="header-anchor" href="#_1-1-1-integer-整数-正整数-负整数-十进制-十六进制" aria-hidden="true">#</a> 1.1.1. Integer 整数（正整数，负整数；十进制，十六进制）</h4><p>Python允许在数字中间以_分隔，因此，写成10_000_000_000和10000000000是完全一样的。十六进制数也可以写成0xa1b2_c3d4。</p><p>注意：Python的整数没有大小限制，而某些语言的整数根据其存储长度是有大小限制的，例如Java对32位整数的范围限制在-2147483648-2147483647。</p><h4 id="_1-1-2-float-浮点数-普通表示-科学计数法表示" tabindex="-1"><a class="header-anchor" href="#_1-1-2-float-浮点数-普通表示-科学计数法表示" aria-hidden="true">#</a> 1.1.2. Float 浮点数（普通表示，科学计数法表示）</h4><p>用科学计数法表示，把10用e替代，1.23x10<sup>9</sup>就是1.23e<sup>9</sup>，0.000012可以写成1.2e<sup>-5</sup>，等等。</p><p>注意：Python的浮点数也没有大小限制，但是超出一定范围就直接表示为inf（无限大）。</p><h3 id="_1-2-string-字符串" tabindex="-1"><a class="header-anchor" href="#_1-2-string-字符串" aria-hidden="true">#</a> 1.2. String 字符串</h3><h4 id="_1-2-1-单行内容和多行内容" tabindex="-1"><a class="header-anchor" href="#_1-2-1-单行内容和多行内容" aria-hidden="true">#</a> 1.2.1. 单行内容和多行内容</h4><h5 id="_1-2-1-1-单行内容" tabindex="-1"><a class="header-anchor" href="#_1-2-1-1-单行内容" aria-hidden="true">#</a> 1.2.1.1. 单行内容</h5><ul><li>用单引号&#39;或双引号&quot;括起来表示单行内容</li><li>单行内容为了美观用反斜杠\\换行写，实际还是单行内容</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 用&#39;表示单行内容
