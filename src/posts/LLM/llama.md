...
## 2. Llama Overall Architecture
![Llama Overall Architecture](images/Llama_Overall_Architecture.png)

![Source Code Corresponding to Model Architecture](images/Llama_Source_Code_Architecture.png)

![Llama vs Transformer](images/llama_vs_transformer.png)

## 3. Hyperparameters
![Hyperparameters](images/llama_hyperparameters.png)

## 4. Tensor Dimensionality Transformation
![Tensor Dimension Transformation](images/llama_dim_trans.png)

![Tensor Dimension Transformation Details](images/LlamaForCausalLM.png)

## 5. Number of Trainable Parameters
![Number of Trainable Parameters](images/llama_trainable_parameters.png)
...
```
### 6.2. GenerationMixin
![Inherit Relation of LlamaForCausalLM and GenerationMixin](images/Inheritance.png)
```python
